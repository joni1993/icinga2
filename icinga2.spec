...
%define gcc_c_package gcc44
%define gcc_cxx_package gcc44-c++
%define gcc_c_name gcc44
%define gcc_cxx_name g++44
%endif
...
CC=%{gcc_c_name} CXX=%{gcc_cxx_name} cmake $CMAKE_OPTS .
